...
#' with matrices of covariates for \eqn{x__i} and \eqn{x___i} and with matrix of transposed for \eqn{x_i}.
...
#' @examples
#' \dontrun{
#' subsi3c_i23(Zag,nf,Parnam,Parmen,WW4,WW5)
#' }
#'
#' @export
#'
subsi3c_i23=function(Zag,nf,Parnam,Parmen,WW4,WW5){
  ...
  for (i in 1:(nf+2)){
    ...
    Zag=gsub(paste0("x_",as.character(i)),paste0("tU2_",as.character(i)),Zag)
  }
