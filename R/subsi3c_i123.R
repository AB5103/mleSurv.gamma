...
#'
#' @param Zag A character object. Includes variables 'x_i', 'x__i' and 'x___i' corresponding to covariates.
...
#' @details Text 'Zag' stands for an expression. Variables \eqn{x_i}, \eqn{x__i} and \eqn{x___i} are replaced
#' with matrices of covariates Finally, the full sum of expression over all subjects is calculated.
...
#' @examples
#' \dontrun{
#' subsi3c_i123(Zag,nf,Parnam,Parmen,WW6)
#' }
#'
#' @export
#'
subsi3c_i123=function(Zag,nf,Parnam,Parmen,WW6){
  ...
  for (i in 1:(nf+2)){
    ...
    Zag=gsub(paste0("x___",as.character(i)),paste0("U1_",as.character(i)),Zag)
  }
