...
#' with matrices of covariates for \eqn{x_i} and \eqn{x__i} and with matrix of transposed for \eqn{x___i}.
...
#' @examples
#' \dontrun{
#' subsi3c_i12(Zag,nf,Parnam,Parmen,WW4,WW5)
#' }
#'
#' @export
#'
subsi3c_i12=function(Zag,nf,Parnam,Parmen,WW4,WW5){
  ...
  for (i in 1:(nf+2)){
    ...
    Zag=gsub(paste0("x__",as.character(i)),paste0("U2_",as.character(i)),Zag)
    Zag=gsub(paste0("x___",as.character(i)),paste0("tU2_",as.character(i)),Zag)
  }
